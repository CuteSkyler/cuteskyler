...
let meetfoxy_4 = {
    prompt: [ `Foxy`, `Heyhey! My name's Foxy! Sorry if I scared you, seeing how big I am, haha! Hope you're doing alright; I see you're also getting your pump on, glad to see it!`, 'currentSize', 'beach-bg', characters.Foxy.Gif],
    options: [
        'You respond...'
    ],
    functions: [
...
let meetfoxy_6 = {
    prompt: [ `Foxy`, `Oh yeah, for sure, dude! You'll see me getting more muscle before you can say 'dumbbell'! It was great meeting you, Vanessa! Let's meet again sometime, with hopefully larger bodies!`, 'currentSize', 'beach-bg', characters.Foxy.Gif],
    options: [

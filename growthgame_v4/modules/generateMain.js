...
let achievements = [
    ...
    {id: 3, name: "I need to be smart for this?", description: "Gained the ability to livestream!", image: 'https://cdn.drawception.com/drawings/1052639/GVG2rJHrAq.png', rare: false, gotten: false},
    {id: 4, name: "Outclassing everyone", description: "Gained the ability to attend bodybuilding competitions!", image: 'https://i.pinimg.com/originals/05/16/2e/05162ebe0f6fa2ffb53c74b418475201.jpg', rare: false, gotten: false}
]
let too_tired = {
    prompt: [ '', `Vanessa is feeling way too tired to do anything anymore for the day, let's sleep it out for now...`, '', 'bedroom-bg'],
    options: [
        'Sleep...'
    ],
    functions: [
